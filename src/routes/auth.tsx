...
function AuthPage() {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-blush px-5 py-16">
        ...
        <div className="rounded-3xl bg-card p-8 shadow-soft">
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="email" type="email" value={email} required className="h-11 rounded-xl"
                onChange={(e) => setEmail(e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" value={password} required minLength={6} className="h-11 rounded-xl"
