...
const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Sweet Crumb — Artisan Cake Boutique" },
      { name: "description", content: "Handcrafted cakes, cupcakes and cheesecakes baked fresh daily." },
      { property: "og:title", content: "Sweet Crumb — Artisan Cake Boutique" },
      { property: "og:description", content: "Handcrafted cakes, cupcakes and cheesecakes baked fresh daily." },
