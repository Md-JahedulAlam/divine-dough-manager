...
function AdminPage() {
  ...
  if (!isAdmin) {
    return (
      <div className="grid min-h-screen place-items-center bg-blush px-5 text-center">
      ...
      <Card>
        ...
        >
          ...
          <div className="flex gap-2 pt-1">
            ...
            {editingId && (
              <Button type="button" variant="chocolate-outline" onClick={reset}>
                Cancel
              </Button>
            )}
          </div>
...
function ReviewsPanel({
  ...
  reviews: { id: string; customer_name: string; rating: number; review_text: string; review_date: string; product_id: string | null }[];
  products: Product[];
  onChange: () => void;
}) {
