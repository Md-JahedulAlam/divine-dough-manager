...
function ProductCard({
  ...
  return <article className="card-lift group flex flex-col overflow-hidden rounded-3xl bg-card">
  ...
  /> : <div className="grid h-full place-items-center text-muted-foreground">No image</div>}
        {categoryName && <span className="absolute top-3 left-3 rounded-full bg-cream/90 px-3 py-1 text-[11px] font-bold tracking-wide text-chocolate backdrop-blur">
            {categoryName}
          </span>}
      </button>
