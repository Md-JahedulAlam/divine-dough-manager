...
export function Hero({ onOrder, avg, count }: { onOrder: () => void; avg: number; count: number }) {
  return (
    <section id="home" className="relative min-h-[92vh] overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[92vh] max-w-7xl items-center px-5 pt-24 pb-16 lg:px-8">
        <div className="max-w-xl">
          ...
          {count > 0 && (
            <div className="mt-10 inline-flex items-center gap-3 rounded-full bg-card/80 px-4 py-2 shadow-card backdrop-blur">
